function restore() {
  chrome.storage.sync.get({ apiKey: '', apiBase: 'https://garminbadges.com/api' }, (data) => {
...
function save() {
  ...
  const apiBase = document.getElementById('apiBase').value.trim() || 'https://garminbadges.com/api';
